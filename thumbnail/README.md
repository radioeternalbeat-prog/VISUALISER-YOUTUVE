...
## Qué incluye (según el brief de la Ficha Técnica)

- **POV de cabina deportiva**: marco tipo parabrisas + pilares A en fibra de carbono.
- **Tablero digital en Azul Eléctrico**: tacómetro (RPM) a la izquierda, velocímetro
  a la derecha, display central "NIGHT DRIVE".
- **Carretera nocturna / túnel** con líneas de fuga hacia un punto de fuga con
  resplandor azul, y estelas de velocidad (motion blur) en blanco/celeste.
...
- **"SESSION #01"** y el subtítulo de género musical, en blanco/azul eléctrico.
- Marca "ETERNAL BEAT MEDIOS" en la esquina inferior derecha.
...
- **Agregar tu logo real**: podés insertar un `<image>` con tu logo en PNG/SVG
  en lugar de (o además de) la marca de texto "ETERNAL BEAT MEDIOS".
